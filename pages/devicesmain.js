import{Menu,MenuButton,ChevronDownIcon,MenuList,MenuItem ,Flex,Grid,Heading,Image,
    ...
    InputRightElement,Switch ,AccordionPanel,AccordionButton,AccordionItem,Accordion,NumberInput,
    NumberInputField,
    NumberInputStepper,
...
{/* device info section */}
  ...
  <Heading fontSize="24px" fontWeight="normal">Launch</Heading>
  ...
  <Box w="35%" h="425px" border="1px solid black" ml={2}  overflow='scroll' overflowX='hidden'>
  <Flex flexDir="row" mt={2} ml={12}>
        <Box w="50%">
           <Flex flexDir="column">
               <Heading fontWeight="bold" fontSize="14px">Audio Output</Heading>
    ...
    <Flex bgColor="gray.100" justifyContent="space-between" justifyContent="center" mt={2}>
    <Box p="4px" fontSize="20px" fontWeight="600">Announcement</Box>
</Flex>
 <Flex flexDir="row" mt={2} ml={12}>
        <Box w="50%">
           <Flex flexDir="column">
               <Heading fontWeight="bold" fontSize="14px" mt={8}>Ready</Heading>
               <Heading fontWeight="bold" fontSize="14px" mt={8}>Total Distance</Heading>
               <Heading fontWeight="bold" fontSize="14px" mt={8}>Carry Distance</Heading>
           </Flex>
        </Box>
        <Box w="50%">
           <Flex flexDir="column">
...
<Flex bgColor="gray.300" justifyContent="space-between" ml={4} justifyContent="center">
    <Box p="10px" fontSize="30px" fontWeight="600">Sound + Tips</Box>
</Flex>
